...
For the information in the C# files ' ', ' ', and ' ', regarding about 'namespace' and 'using' statements as well as their applications in the structure of the C# programming language, their sources are taken separately from.  (due to the higher complexity of these concepts, and that they aren't present in the Python programming language)
